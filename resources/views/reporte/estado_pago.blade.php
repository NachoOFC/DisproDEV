...
@section('title', 'Generar Reporte | MLine SIGER')
...
@section('main')
    <div class="container">
        <div class="card">
            <h3 class="card-header font-bold text-xl">{{ Auth::user()->getNombreRelacionado() }}: Generar Estado de Pago</h3>
            <div class="card-body">
                <div class="d-flex flex-row mb-2">
                </div>
                <div class="container mt-2">
                    <form action="{{ route('reportes.estadoPago.generar') }}" method="POST" accept-charset="utf-8">
                        @csrf
                        ...
                        <button class="btn btn-primary">Generar Estados de Pago</button>
                    </form>
                </div>
            </div>
        </div>
