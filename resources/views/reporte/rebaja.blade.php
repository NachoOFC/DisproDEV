                ...
                <form action="{{ route('reportes.productos.generar') }}" method="POST" accept-charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div>
                                <autoselect :items='@json($productos)' item-text="detalle" item-value="sku" name="productos" multiple></autoselect>
                            </div>
                        </div>
                    </div>
                        ...
                        <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                <div class="form-group row">
                                    ...
                                    <span class="col-sm-6">
                                        <autoselect :items='@json($zonas)' item-text="nombre" item-value="id" name="zonas" :multiple="true"></autoselect>
                                    </span>
                                </div>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                    ...
                    <button class="btn btn-primary mt-2">Generar Rebaja</button>
                </form>
            </div>
        </div>
    </div>
