...
@section('title', 'Historial de Guias | MLine SIGER')
...
<div class="container">
    <div class="card">
        <h3 class="card-header font-bold text-xl">{{ Auth::user()->getNombreRelacionado() }}: Historial de Guias</h3>
        <div class="card-body">
            <div class="d-flex flex-row mb-2">
            </div>
            <div class="container mt-2">
                <form action="{{ route('reportes.guias.filter') }}" method="POST" accept-charset="utf-8">
                    @csrf
