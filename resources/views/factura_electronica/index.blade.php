...
<div class="container">
    <div class="card">
        <h3 class="card-header font-bold text-xl">{{ Auth::user()->getNombreRelacionado() }}: Control de Facturas Electronicas</h3>
        <div class="card-body">
            <div class="container mt-2">
                <form class="flex flex-row items-end" method="POST" action="{{ route("factura_electronica_filtrar")  }}">
                    @csrf
                ...
                <table class="table table-sm" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('factura_electronica_cierre', $cierre)  }}">Seleccionar</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
